  ...
  test('counts only window dates and aggregates per day', () {
    final habits = [
      ...
      Habit(
        ...
        repeatDays: const ['Tue'],
        completedDates:  [
          DateTime(2024, 1, 5), // same day as Habit A’s completion -> counts as 2
    ...
    expect(map.containsKey(DateTime(2023, 12, 30)), isFalse); // outside window ignored
  });
});
...
expect(snapshot.topStreak!.best, 3); // or higher if you add a longer historical run
  });
